...
public class TP3Test5 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Partido bocaVsSanLorenzo = new Partido(boca, sanLorenzo, 5, 4); Partido
		 * riverVsRacing = new Partido(river, racing, 1, 2); Partido
		 * velezVsIndependiente = new Partido(velez, independiente, 2, 6);
		 */
