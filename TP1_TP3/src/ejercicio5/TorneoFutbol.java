...
public abstract class TorneoFutbol {
	...
	public void mostrarTabla() {
		System.out.println("es un torneo: "+this.getClass().getSimpleName());
	...
	public void calcularPuntos(Partido partido) {
		int puntosLocal = 0;		// puntos a asignar al local (pisando los que ten�a)
		int puntosVisitante = 0;	// puntos a asignar al visitante (pisando los que ten�a)
