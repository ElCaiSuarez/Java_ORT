...
public class Parcial2 {
	...
	private static final int ONCE = 23;
	...
	private static void guardarJuguetes(Jugueteria jugueteria) {
		...
		guardarPeluche(jugueteria, id++, "Baloo", "Us Open", 1200.9f);//10
		guardarTitere(jugueteria, id++, "Bandai", 100, 2304.7f);//11
		guardarPelota(jugueteria, id++, "Wilson", TipoDePelota.FUTBOL, 1234.5f);//12
		guardarPeluche(jugueteria, id++, "", "Us Open 2", 1700.9f);//13
		guardarTitere(jugueteria, id++, "Pinoche", 105, 2304.7f);//14
		guardarPeluche(jugueteria, id++, "Marvel", "All Team", 2300.5f);//15
		guardarTitere(jugueteria, id++, "Prince", 98, 2304.7f);//16
		guardarPelota(jugueteria, id++, "Wilson", TipoDePelota.GOLF, 1234.5f);//17
		guardarPeluche(jugueteria, id++, "Hasbro", null, 2300.5f);//18
		guardarTitere(jugueteria, id++, "Babies", 544, 2301.7f);//19
		guardarPelota(jugueteria, id++, "Wilson", null, 1234.5f);//20
		for (int i = 0; i < ONCE; i++) {//AGREGA 12 PELOTAS
